...
object b2s10Problema1 extends App {


  // Define una Var[List[Int]] inicializada con List(10) como  nos pide en el ejemplo.
  //la var es una variable mutable que la modificamos con los sets
  val calificaciones: Var[List[Int]] = Var(List(10))


  // Cada vez que 'calificaciones' cambie, este bloque se ejecuta de nuevo.
  // Usamos .sum para sumar los elementos de la lista.
  val sumaTotal: Signal[Int] = Signal {
    calificaciones.value.sum
  }
  
  // Usa un observador para imprimir en consola automáticamente.
  val observador = sumaTotal.changed.observe { suma =>
    println(s"Suma actual = $suma")
  }

  // Actualización 1: Agregamos un 10 a la lista existente.
  // Lista pasa de List(10) -> List(10, 10). Suma esperada: 20
  calificaciones.set(calificaciones.now :+ 10)

  // Actualización 2: Agregamos un 20 a la lista existente.
  // Lista pasa de List(10, 10) -> List(10, 10, 20). Suma esperada: 40
  calificaciones.set(calificaciones.now :+ 20)

}
```
# Ejecucion
<img width="1316" height="275" alt="Screenshot 2025-12-12 at 4 15 45 PM" src="https://github.com/user-attachments/assets/aa974f69-5adb-4e3d-be16-5d4818880a89" />
...
object b2s10Problema2 extends App {


  // Inicializamos con los valores del escenario de prueba: m=1000, v=30
  val masa: Var[Double] = Var(1000.0)
  val velocidad: Var[Double] = Var(30.0)

  // Fórmula: Ek = 0.5 * m * v^2
  val energiaCinetica: Signal[Double] = Signal {
    0.5 * masa.value * Math.pow(velocidad.value, 2)
  }

  // Este bloque se dispara automáticamente cada vez que 'energiaCinetica' cambia.
  val observador = energiaCinetica.observe { e =>
  ...
  // El estado Inicial ya se imprimió al definir el observador

  // Actualizar velocidad a 50
  // Resultado esperado: 0.5 * 1000 * 50^2 = 1,250,000 . Debe salir Alerta
  velocidad.set(50.0)

  // Paso 3: Actualizar masa a 2000
  // Resultado esperado: 0.5 * 2000 * 50^2 = 2,500,000. Debe salir una alerta
  masa.set(2000.0)
}
...
# Ejecucion
---
<img width="1318" height="233" alt="Screenshot 2025-12-12 at 4 18 09 PM" src="https://github.com/user-attachments/assets/06ec08c5-60db-4665-b025-dc7f1676aaa4" />

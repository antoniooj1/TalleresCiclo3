...
object Problema1 extends App{
  ...
  // Aquí definimos QUÉ hacer con los datos y retornamos el mensaje listo
...
object Problema2 extends App {
  ...
  // 2. Suscripción directa
  sensores.take(20).subscribe { case (t, h, p) =>

    // Imprimir datos
    print(s"Temp: $t°C, Hum: $h%, Pres: $p hPa")

    // Detectar alertas (en una sola línea cada uno para ahorrar espacio)
